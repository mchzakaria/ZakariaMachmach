...
function AppContent() {
  ...
  useEffect(() => {
    console.log(
      "%cHey developer! You found the console easter egg.",
      "color: #8b5cf6; font-size: 16px; font-weight: bold;"
    );
    console.log(
      "%cZakaria MACHMACH - Full Stack Developer",
      "color: #a78bfa; font-size: 14px;"
    );
    console.log(
      "%czakariamachmach03@gmail.com | github.com/mchzakaria",
      "color: #6d28d9; font-size: 12px;"
    );
    console.log(
      "%cTry the Konami code: up up down down left right left right B A",
